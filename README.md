...
This model has a cable ending in a DC-37 D-sub connector and no direct outputs.
...
```
PARALLEL_KBD_OPTS = -DKEYBOARD="\"SW-10034 Keyboard\"" -DCHAR_INVERT -DPARITY_CHECK=PARITY_ODD
```
